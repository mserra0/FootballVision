...
class Tracker:
        ...
        for object, object_tracks in tracks.items():
            for n_frame, track in enumerate(object_tracks):
                for track_id, track_info in track.items():
                    ...
                    tracks[object][n_frame][track_id]["position"] = position
    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        tracks = {
            "players":[], # {0(track_id):{"bbox":[x, y, x, y]},, 1:{...}}, {}...
            "referees":[],
            "ball":[]
        }
        ...
        for frame_num, detection in enumerate(detections):
            ...
            # Convertir porter a jugador (provisional)
    ...
    def draw_team_ball_possession(self, frame, n_frame, team_ball_possession):
        overlay = frame.copy()
        cv2.rectangle(overlay, (1350, 850), (1900, 970), (255, 255, 255), -1)
        alpha = 0.4
        cv2.addWeighted(overlay, alpha, frame, 1 - alpha, 0, frame)
        
        current_team_ball_possession = team_ball_possession[:n_frame + 1]
        
        team_1_n_frames = current_team_ball_possession[current_team_ball_possession==1].shape[0]
        team_2_n_frames = current_team_ball_possession[current_team_ball_possession==2].shape[0]
        
        team_1 = team_1_n_frames/(team_1_n_frames + team_2_n_frames)
        team_2 = team_2_n_frames/(team_1_n_frames + team_2_n_frames)
    ...
    def draw_annotations(self, frames, tracks, team_possession):
        ...
        for frame_num, frame in enumerate(frames):
            ...
            # Dibuixar posessió de la pilota
            frame = self.draw_team_ball_possession(frame, frame_num, team_possession)
